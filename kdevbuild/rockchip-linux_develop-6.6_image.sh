...
export BUILD_TAG="decenta_develop-6.6_${set_rootfs}"
...
wget -c https://github.com/yifengyou/S21-RK3588-BOX18/releases/download/rockchip-linux_develop-6.6_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/S21-RK3588-BOX18/releases/download/rockchip-linux_develop-6.6_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/S21-RK3588-BOX18/releases/download/rockchip-linux_develop-6.6_kernel/config-6.6-kdev
ls -alh config-6.6-kdev
md5sum config-6.6-kdev

wget -c https://github.com/yifengyou/S21-RK3588-BOX18/releases/download/rockchip-linux_develop-6.6_kernel/System.map-6.6-kdev
ls -alh System.map-6.6-kdev
md5sum System.map-6.6-kdev

wget -c https://github.com/yifengyou/S21-RK3588-BOX18/releases/download/rockchip-linux_develop-6.6_kernel/decenta_rk3588.dtb
ls -alh decenta_rk3588.dtb
md5sum decenta_rk3588.dtb

wget -c https://github.com/yifengyou/S21-RK3588-BOX18/releases/download/rockchip-linux_develop-6.6_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
